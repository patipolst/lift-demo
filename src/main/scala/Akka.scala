...
//
// trait AkkaHttpCaller extends JsonHttpServiceDelegate with JsonResponseExceptionHelper {
...
//     def toLiftResponseFuture(headers: List[(String, String)] = ("Content-Type", "application/json; charset=utf-8") :: Nil)(implicit ec: ExecutionContext): Future[LiftResponse] = {
